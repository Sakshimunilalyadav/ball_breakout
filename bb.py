...
brick_sound = pygame.mixer.Sound("E:/sakshi_proj/__pycache__/sounds_brick.wav") 
paddle_sound = pygame.mixer.Sound("E:/sakshi_proj/__pycache__/sounds_paddle.wav")
wall_sound = pygame.mixer.Sound("E:/sakshi_proj/__pycache__/sounds_wall.wav")
...
def main(score, balls):
    ...
    while run:
        ...
        if ball.rect.y > HEIGHT:
            ...
            balls += 1
            if balls == 4:
                font = pygame.font.Font("E:/sakshi_proj/__pycache__/DSEG14Classic-Bold.ttf", 70)
                text = font.render("END", 1, WHITE)
       ...
       ## pygame.draw.line(screen, PINK, [(wall_width / 2) - 1, 212.5 + 8 * brick_height + 8 * y_gap], [(wall_width / 2) - 1, 212.5 + 10 * brick_height + 10 * y_gap], wall_width)
        ##pygame.draw.line(screen, PINK, [(WIDTH - wall_width / 2) - 1, 212.5 + 8 * brick_height + 8 * y_gap], [(WIDTH - wall_width / 2) - 1, 212.5 + 10 * brick_height + 10 * y_gap], wall_width)
